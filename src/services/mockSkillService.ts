...
let skills: Skill[] = [
  {
    id: 's1',
    name: 'ASP.NET Core',
    description: 'Building the REST API layer for Mesh — routing, EF Core, auth, and the middleware pipeline.',
    category: 'Backend',
    status: 'In Progress',
    progressPercent: 80,
    roadmapId: 'rm1',
    milestones: [
      {
        ...
        syllabus: [
          ...
          { id: 'r3', title: 'Auth (Identity/JWT)', details: 'Token issuing, refresh tokens, role-based auth.', done: true, projectRefs: [{ type: 'project', id: 'p1', title: 'Mesh' }] },
      ...
      },
      {
        ...
        projectRefs: [{ type: 'project', id: 'p1', title: 'Mesh' }],
        syllabus: [],
      },
    ],
    resources: [
    ...
    projects: [{ type: 'project', id: 'p1', title: 'Mesh' }],
    tags: ['backend'],
    favorite: true,
    createdAt: '2026-05-01',
    updatedAt: '2026-08-15',
  },
  {
    ...
    description: 'The frontend stack for Mesh — components, hooks, and the mock-to-API service pattern.',
    category: 'Frontend',
    status: 'In Progress',
    progressPercent: 60,
    roadmapId: 'rm2',
    ...
    notes: '<p>The service-abstraction pattern (interface + mock + real) is doing a lot of work — worth reusing outside Mesh too.</p>',
    projects: [{ type: 'project', id: 'p1', title: 'Mesh' }],
    tags: ['frontend'],
    favorite: false,
  ...
  },
  {
    id: 's3',
    name: 'Flutter',
    description: 'Parked until the Mesh API exists — will consume the same endpoints as the web app.',
    category: 'Mobile',
    status: 'Not Started',
    progressPercent: 0,
    roadmapId: null,

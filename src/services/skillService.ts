...
import type { RoadmapDraft, Skill, SkillDraft, SkillRoadmap, SkillStatus } from '../types/skill';
...
export interface SkillService {
  ...
  moveMilestone(skillId: string, milestoneId: string, direction: 'up' | 'down'): Promise<Skill>;
  ...
  moveSyllabusItem(skillId: string, milestoneId: string, itemId: string, direction: 'up' | 'down'): Promise<Skill>;
  ...
  movePracticeTask(skillId: string, taskId: string, direction: 'up' | 'down'): Promise<Skill>;

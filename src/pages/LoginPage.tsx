    ...
    <div className="auth-stage">
      ...
      <div className="auth-header">
        ...
        <div className="auth-toggle">
          <button type="button" className="auth-toggle-button active">Sign in</button>
          <button type="button" className="auth-toggle-button" onClick={onSwitchToRegister}>Sign up</button>
        </div>
      </div>
            ...
            <div className="social-block social-block--inline">
              {SOCIAL_PROVIDERS.map(({ provider, label }) => (
                <button
                  ...
                  onClick={() => socialLogin.mutate(provider)}
